...
You can install the development version of yarrariver from
...
- Source: [Victorian Water Measurement Information System
  (WMIS)](https://data.water.vic.gov.au/).

- Site coverage: CHANDLER HIGHWAY KEW.

- Parameter: pH, Water Temperature, Turbidity, Salinity as electrical
  conductivity.
